package com.neusoft.qiangzi.bottomnavdemo.ui.motivation;
...
public class ScaleFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        ImageView imageView = getView().findViewById(R.id.imageViewScale);
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                float factor = new Random().nextBoolean()?0.2f:-0.2f;
                ObjectAnimator.ofFloat(view, "scaleX",
                        view.getScaleX()+ factor).start();
